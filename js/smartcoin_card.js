...
Card = (function() {
  Card.prototype.cardTemplate = "<div class=\"card-container\">\n    <div class=\"card\">\n        <div class=\"front\">\n                <div class=\"card-logo visa\">visa</div>\n                <div class=\"card-logo mastercard\">MasterCard</div>\n                <div class=\"card-logo amex\"></div>\n  <div class=\"card-logo dinersclub\"><span class=\"half-moon-left\"></span><span class=\"half-moon-right\"></span>Diners Club</div>\n <div class=\"card-logo elo\">el<div class=\"circle\"><div class=\"sector1\"></div><div class=\"sector2\"></div><div class=\"round-middle\"></div></div></div>\n        <div class=\"lower\">\n                <div class=\"shiny\"></div>\n                <div class=\"cvc display\">{{cvc}}</div>\n                <div class=\"number display\">{{number}}</div>\n                <div class=\"name display\">{{name}}</div>\n                <div class=\"expiry display\" data-before=\"{{monthYear}}\" data-after=\"{{validDate}}\">{{expiry}}</div>\n            </div>\n        </div>\n        <div class=\"back\">\n            <div class=\"bar\"></div>\n            <div class=\"cvc display\">{{cvc}}</div>\n            <div class=\"shiny\"></div>\n        </div>\n    </div>\n</div>";
  ...
  Card.prototype.cardTypes = ['dinersclub', 'mastercard', 'amex', 'visa', 'elo'];
